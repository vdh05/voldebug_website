...
export default function AboutPage({ darkMode }) {
  ...
  return (
    <>
      ...
      <Spacing lg="75" md="60" />
      <AboutStyle4
        thumbnailSrc="/images/digital-agency/about_v1.png"
        miniTitle="Company Info"
        title="Innovation agency for your business"
        subTitle="Voldebug Innovations Pvt. Ltd is a leading provider of comprehensive digital solutions. We offer a wide range of services including web development, mobile app development, SEO, landing page optimization, web design, and software-related services. 
        Our team of experts is dedicated to delivering exceptional results and helping our clients succeed in the digital landscape. With our expertise and tailored solutions, we ensure that businesses have a strong online presence and effectively engage with their target audience. Whether it's developing a robust website, optimizing landing pages for maximum conversions, or providing software solutions, we have the capabilities to meet diverse client needs."
      ...
      <AboutStyle5
        variant="cs_type_1"
        thumbnailSrc="/images/digital-agency/about_v2.avif"
        miniTitle="What We Do"
        title="Best value service provider agency"
        subTitle="Crafting visually appealing websites and custom mobile applications, we deliver tailored solutions to meet your business needs.
        CCTV camera and security system services and IT Services."
        progressBarList={[
